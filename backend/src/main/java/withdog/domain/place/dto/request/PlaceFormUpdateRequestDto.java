...
public class PlaceFormUpdateRequestDto {
    ...
    @Builder
    public PlaceFormUpdateRequestDto(String category, String name, String phone, String addressPart1, String addressPart2, int price, String reservationUrl, String description, List<String> blogUrls, List<PlaceNewImageDto> newImages, List<PlaceUpdateImagesDto> updateImages, List<Long> removedImageIds) {
